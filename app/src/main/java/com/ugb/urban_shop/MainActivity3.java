    ...
    private void guardarUsuario(){
        try{
            ...
            if( miToken!=null && miToken!="" ){
                usuarios user = new usuarios(nombre, "gustavoargueta363@gmail.com", urlCompleteImg, urlCompleteImgFirestore, miToken);
                if(key!=null){
    ...
    void tomarFoto() {
        ...
        imgPhoto.setOnClickListener(v->{
            ...
            if (takePhotoIntent.resolveActivity(getPackageManager()) != null) {
                ...
                if (photoFile != null) {
                    try {
                        Uri photoURI = FileProvider.getUriForFile(MainActivity3.this, "com.ugb.urban_shop.fileprovider", photoFile);
